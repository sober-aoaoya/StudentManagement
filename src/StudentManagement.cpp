...
// StudentManagement.cpp: 定义应用程序的类行为。
//
...
// CStudentManagementApp 构造

CStudentManagementApp::CStudentManagementApp()
{
	// 支持重新启动管理器
...
// 唯一的 CStudentManagementApp 对象

CStudentManagementApp theApp;


// CStudentManagementApp 初始化
